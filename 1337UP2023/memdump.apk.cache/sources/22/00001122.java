    ...
    public static ShapeAppearanceModel convertToRelativeCornerSizes(ShapeAppearanceModel shapeAppearanceModel, final RectF bounds) {
        return shapeAppearanceModel.withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator() { // from class: com.google.android.material.transition.TransitionUtils$$ExternalSyntheticLambda0
            ...
            public final CornerSize apply(CornerSize cornerSize) {
                return TransitionUtils.lambda$convertToRelativeCornerSizes$0(bounds, cornerSize);
            }
        });
    }

    public static /* synthetic */ CornerSize lambda$convertToRelativeCornerSizes$0(RectF bounds, CornerSize cornerSize) {
