...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            if (layoutState.hasMore(state)) {
                ...
                boolean assignSpan = spanIndex == -1 ? r10 : r9;
                if (assignSpan) {
                ...
                if (lp.mFullSpan && layoutState.mItemDirection == -1) {
                    if (assignSpan) {
                        ...
                        if (layoutState.mLayoutDirection == r10) {
                            i2 = (areAllEndsEqual() ? 1 : 0) ^ r10;
                        } else {
                            boolean hasInvalidGap = areAllStartsEqual();
                            i2 = (hasInvalidGap ? 1 : 0) ^ r10;
                        }
                        if (i2 != 0) {
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new Parcelable.Creator<FullSpanItem>() { // from class: androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem.1
                ...
                public FullSpanItem createFromParcel(Parcel in2) {
            ...
            FullSpanItem(Parcel in2) {
                this.mPosition = in2.readInt();
                this.mGapDir = in2.readInt();
                this.mHasUnwantedGapAfter = in2.readInt() == 1;
                int spanCount = in2.readInt();
                if (spanCount > 0) {
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel in2) {
            ...
            this.mVisibleAnchorPosition = in2.readInt();
            ...
            this.mReverseLayout = in2.readInt() == 1;
            this.mAnchorLayoutFromEnd = in2.readInt() == 1;
            this.mLastLayoutRTL = in2.readInt() == 1;
            List<LazySpanLookup.FullSpanItem> fullSpanItems = in2.readArrayList(LazySpanLookup.FullSpanItem.class.getClassLoader());
