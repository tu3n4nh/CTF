...
public final class Utf8Safe extends Utf8 {
    ...
    public int encodedLength(CharSequence in2) {
        return computeEncodedLength(in2);
    }
        ...
        while (inIx < inLength) {
            ...
            if (c2 < 128) {
                ...
                try {
                    ...
                    throw new ArrayIndexOutOfBoundsException("Failed writing " + in2.charAt(inIx) + " at index " + badWriteIndex2);
                }
                ...
                if (inIx + 1 != inLength) {
                    ...
                    if (Character.isSurrogatePair(c2, low)) {
                        ...
                        try {
                            ...
                            throw new ArrayIndexOutOfBoundsException("Failed writing " + in2.charAt(inIx) + " at index " + badWriteIndex22);
                        }
                    }
                }
    ...
    */
    ...
    public void encodeUtf8(CharSequence in2, ByteBuffer out) {
        if (out.hasArray()) {
            ...
            int end = encodeUtf8Array(in2, out.array(), out.position() + start, out.remaining());
            out.position(end - start);
            return;
        }
        encodeUtf8Buffer(in2, out);
    }
