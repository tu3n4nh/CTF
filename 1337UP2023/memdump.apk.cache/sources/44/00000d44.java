...
public final class MultiBrowseCarouselStrategy extends CarouselStrategy {
    ...
    public static final class Arrangement {
        ...
        private void fit(float availableSpace, float minSmallSize, float maxSmallSize, float targetLargeSize) {
            ...
            float calculateLargeSize = calculateLargeSize(availableSpace, this.smallCount, this.smallSize, this.mediumCount, this.largeCount);
            this.largeSize = calculateLargeSize;
            float f3 = (this.smallSize + calculateLargeSize) / 2.0f;
            this.mediumSize = f3;
            int i2 = this.mediumCount;
            if (i2 > 0 && calculateLargeSize != targetLargeSize) {
                float targetAdjustment = (targetLargeSize - calculateLargeSize) * this.largeCount;
                float availableMediumFlex = f3 * 0.1f * i2;
