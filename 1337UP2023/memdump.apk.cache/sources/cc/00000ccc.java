...
public final class BadgeState {
    ...
    public BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        if (storedState.horizontalOffsetWithText == null) {
            intValue10 = a.getDimensionPixelOffset(R.styleable.Badge_horizontalOffsetWithText, state.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (storedState.verticalOffsetWithText == null) {
            intValue11 = a.getDimensionPixelOffset(R.styleable.Badge_verticalOffsetWithText, state.verticalOffsetWithoutText.intValue());
        } else {
    ...
    public static final class State implements Parcelable {
        ...
        public static final Parcelable.Creator<State> CREATOR = new Parcelable.Creator<State>() { // from class: com.google.android.material.badge.BadgeState.State.1
            ...
            public State createFromParcel(Parcel in2) {
                return new State(in2);
            }
        ...
        State(Parcel in2) {
            ...
            this.maxCharacterCount = -2;
            this.isVisible = true;
            this.badgeResId = in2.readInt();
            this.backgroundColor = (Integer) in2.readSerializable();
            this.badgeTextColor = (Integer) in2.readSerializable();
            this.badgeTextAppearanceResId = (Integer) in2.readSerializable();
            this.badgeShapeAppearanceResId = (Integer) in2.readSerializable();
            this.badgeShapeAppearanceOverlayResId = (Integer) in2.readSerializable();
            this.badgeWithTextShapeAppearanceResId = (Integer) in2.readSerializable();
            this.badgeWithTextShapeAppearanceOverlayResId = (Integer) in2.readSerializable();
            this.alpha = in2.readInt();
            this.number = in2.readInt();
            this.maxCharacterCount = in2.readInt();
            this.contentDescriptionNumberless = in2.readString();
            this.contentDescriptionQuantityStrings = in2.readInt();
            this.badgeGravity = (Integer) in2.readSerializable();
            this.horizontalOffsetWithoutText = (Integer) in2.readSerializable();
            this.verticalOffsetWithoutText = (Integer) in2.readSerializable();
            this.horizontalOffsetWithText = (Integer) in2.readSerializable();
            this.verticalOffsetWithText = (Integer) in2.readSerializable();
            this.additionalHorizontalOffset = (Integer) in2.readSerializable();
            this.additionalVerticalOffset = (Integer) in2.readSerializable();
            this.isVisible = (Boolean) in2.readSerializable();
            this.numberLocale = (Locale) in2.readSerializable();
        }
