...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public static final /* synthetic */ void access$registerSelectReceiveMode(AbstractChannel $this, SelectInstance select, int receiveMode, Function2 block) {
        $this.registerSelectReceiveMode(select, receiveMode, block);
    }
    ...
    public final SelectClause1<E> getOnReceive() {
        return new SelectClause1<E>(this) { // from class: kotlinx.coroutines.channels.AbstractChannel$onReceive$1
            ...
            public <R> void registerSelectClause1(SelectInstance<? super R> selectInstance, Function2<? super E, ? super Continuation<? super R>, ? extends Object> function2) {
                AbstractChannel.access$registerSelectReceiveMode(this.this$0, selectInstance, 0, function2);
            }
        };
    }
