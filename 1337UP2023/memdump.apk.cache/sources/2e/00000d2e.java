...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements Carousel {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        int i = isRtl ? endHorizontalScroll : startHorizontalScroll;
        this.minHorizontalScroll = i;
        int i2 = isRtl ? startHorizontalScroll : endHorizontalScroll;
        this.maxHorizontalScroll = i2;
        if (isInitialLoad) {
            this.horizontalScrollOffset = startHorizontalScroll;
        } else {
            int i3 = this.horizontalScrollOffset;
            this.horizontalScrollOffset = i3 + calculateShouldHorizontallyScrollBy(0, i3, i, i2);
        }
    ...
    public void measureChildWithMargins(View child, int widthUsed, int heightUsed) {
        ...
        float childWidthDimension = keylineStateList != null ? keylineStateList.getDefaultState().getItemSize() : lp.width;
    ...
    public void scrollToPosition(int position) {
        ...
        this.horizontalScrollOffset = getScrollOffsetForPosition(keylineStateList.getDefaultState(), position);
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: com.google.android.material.carousel.CarouselLayoutManager.1
            ...
            public PointF computeScrollVectorForPosition(int targetPosition) {
                ...
                float targetScrollOffset = carouselLayoutManager.getScrollOffsetForPosition(carouselLayoutManager.keylineStateList.getDefaultState(), targetPosition);
            ...
            public int calculateDxToMakeVisible(View view, int snapPreference) {
                CarouselLayoutManager carouselLayoutManager = CarouselLayoutManager.this;
                float targetScrollOffset = carouselLayoutManager.getScrollOffsetForPosition(carouselLayoutManager.keylineStateList.getDefaultState(), CarouselLayoutManager.this.getPosition(view));
    ...
    public boolean requestChildRectangleOnScreen(RecyclerView parent, View child, Rect rect, boolean immediate, boolean focusedChildVisible) {
        ...
        int offsetForChild = getScrollOffsetForPosition(keylineStateList.getDefaultState(), getPosition(child));
