...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public static class RangeSliderState extends AbsSavedState {
        public static final Parcelable.Creator<RangeSliderState> CREATOR = new Parcelable.Creator<RangeSliderState>() { // from class: com.google.android.material.slider.RangeSlider.RangeSliderState.1
            ...
            public RangeSliderState createFromParcel(Parcel in2) {
                return new RangeSliderState(in2);
            }
        ...
        private RangeSliderState(Parcel in2) {
            super(in2.readParcelable(RangeSliderState.class.getClassLoader()));
            this.minSeparation = in2.readFloat();
            this.separationUnit = in2.readInt();
        }
