...
public final class UStringsKt {
    ...
    public static final String m1410toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1412toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1411toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1409toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m245unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m324unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m245unboximpl = uIntOrNull.m245unboximpl();
            compare = Integer.compare(m245unboximpl ^ Integer.MIN_VALUE, UInt.m193constructorimpl(255) ^ Integer.MIN_VALUE);
            if (compare > 0) {
                return null;
            }
            return UByte.m110boximpl(UByte.m116constructorimpl((byte) m245unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m245unboximpl = uIntOrNull.m245unboximpl();
            compare = Integer.compare(m245unboximpl ^ Integer.MIN_VALUE, UInt.m193constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE);
            if (compare > 0) {
                return null;
            }
            return UShort.m373boximpl(UShort.m379constructorimpl((short) m245unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m193constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m193constructorimpl(result * uradix);
            result = UInt.m193constructorimpl(UInt.m193constructorimpl(digit) + result2);
            compare2 = Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
        }
        return UInt.m187boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m272constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m272constructorimpl(result * uradix);
            result = ULong.m272constructorimpl(ULong.m272constructorimpl(UInt.m193constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m266boximpl(result);
    }
}