...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1628catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1635catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1629debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m1631debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m1630sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m1632sampleHG0u8IE(flow, period);
    }
