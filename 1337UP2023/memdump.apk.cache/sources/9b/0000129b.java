...
public class ComparisonsKt__ComparisonsKt {
    /* renamed from: $r8$lambda$-gpd5rn26uA_qKcB-hI2DNr-hgw */
    public static /* synthetic */ int m1289$r8$lambda$gpd5rn26uA_qKcBhI2DNrhgw(Comparator comparator, Comparator comparator2, Object obj, Object obj2) {
        return thenDescending$lambda$2$ComparisonsKt__ComparisonsKt(comparator, comparator2, obj, obj2);
    }

    public static /* synthetic */ int $r8$lambda$6WnilmL2ArBCKOeeYXXH8ELrg4w(Comparator comparator, Object obj, Object obj2) {
        return nullsFirst$lambda$3$ComparisonsKt__ComparisonsKt(comparator, obj, obj2);
    }

    public static /* synthetic */ int $r8$lambda$Uw4BAo9Vwbm4C3dkpmfByDP7hFs(Comparator comparator, Object obj, Object obj2) {
        return nullsLast$lambda$4$ComparisonsKt__ComparisonsKt(comparator, obj, obj2);
    }

    public static /* synthetic */ int $r8$lambda$iapHOTD2lDnsDFFbGrAXPm4qZHg(Comparator comparator, Comparator comparator2, Object obj, Object obj2) {
        return then$lambda$1$ComparisonsKt__ComparisonsKt(comparator, comparator2, obj, obj2);
    }

    /* renamed from: $r8$lambda$nq8UCGW90ISdL04-oV8sJ24EEKI */
    public static /* synthetic */ int m1290$r8$lambda$nq8UCGW90ISdL04oV8sJ24EEKI(Function1[] function1Arr, Object obj, Object obj2) {
    ...
    public static final <T> Comparator<T> compareBy(final Function1<? super T, ? extends Comparable<?>>... selectors) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$$ExternalSyntheticLambda1
            ...
            public final int compare(Object obj, Object obj2) {
                return ComparisonsKt__ComparisonsKt.m1290$r8$lambda$nq8UCGW90ISdL04oV8sJ24EEKI(selectors, obj, obj2);
            }
        };
    }
    ...
    public static final <T> Comparator<T> then(final Comparator<T> comparator, final Comparator<? super T> comparator2) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$$ExternalSyntheticLambda0
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return ComparisonsKt__ComparisonsKt.$r8$lambda$iapHOTD2lDnsDFFbGrAXPm4qZHg(comparator, comparator2, obj, obj2);
            }
        };
    }
    ...
    public static final <T> Comparator<T> thenDescending(final Comparator<T> comparator, final Comparator<? super T> comparator2) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$$ExternalSyntheticLambda2
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return ComparisonsKt__ComparisonsKt.m1289$r8$lambda$gpd5rn26uA_qKcBhI2DNrhgw(comparator, comparator2, obj, obj2);
            }
        };
    }
    ...
    public static final <T> Comparator<T> nullsFirst(final Comparator<? super T> comparator) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$$ExternalSyntheticLambda3
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return ComparisonsKt__ComparisonsKt.$r8$lambda$6WnilmL2ArBCKOeeYXXH8ELrg4w(comparator, obj, obj2);
            }
        };
    }
    ...
    public static final <T> Comparator<T> nullsLast(final Comparator<? super T> comparator) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$$ExternalSyntheticLambda4
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return ComparisonsKt__ComparisonsKt.$r8$lambda$Uw4BAo9Vwbm4C3dkpmfByDP7hFs(comparator, obj, obj2);
            }
        };
    }
