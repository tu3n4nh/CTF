...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    */
    ...
    public /* synthetic */ void m52lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton buttonView, boolean isChecked) {
        ...
        if (onCheckedChangeListener2 != null) {
            onCheckedChangeListener2.onCheckedChanged(buttonView, isChecked);
        }
    }
    ...
    public void setTextSize(int unit, float size) {
        ...
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextSize(TypedValue.applyDimension(unit, size, getResources().getDisplayMetrics()));
        }
        updateTextPaintDrawState();
    }
