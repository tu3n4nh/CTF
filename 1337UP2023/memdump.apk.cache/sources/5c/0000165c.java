...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public static final /* synthetic */ void access$registerSelectSend(ConflatedBroadcastChannel $this, SelectInstance select, Object element, Function2 block) {
        $this.registerSelectSend(select, element, block);
    }
    ...
    public final E getValueOrNull() {
        ...
        if (state instanceof State) {
            Symbol this_$iv = UNDEFINED;
            E e = (E) ((State) state).value;
            if (e == this_$iv) {
                return null;
            }
            return e;
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
        ...
        ArraysKt.copyInto$default(subscriberArr, update, 0, 0, i, 6, (Object) null);
        ArraysKt.copyInto$default(subscriberArr, update, i, i + 1, 0, 8, (Object) null);
        return update;
    }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        Object state = this._state;
        if ((state instanceof Closed) && AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo1605trySendJP2dKIU(E e) {
        Closed it = offerInternal(e);
        if (it != null) {
            return ChannelResult.Companion.m1623closedJP2dKIU(it.getSendException());
        }
            ...
            while (true) {
                try {
                    ...
                    if (state instanceof Closed) {
                        ...
                        State update = new State(e, ((State) state).subscribers);
    ...
    public SelectClause2<E, SendChannel<E>> getOnSend() {
        return (SelectClause2) ((SelectClause2<E, SendChannel<? super E>>) new SelectClause2<E, SendChannel<? super E>>(this) { // from class: kotlinx.coroutines.channels.ConflatedBroadcastChannel$onSend$1
            ...
            public <R> void registerSelectClause2(SelectInstance<? super R> selectInstance, E e, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
                ConflatedBroadcastChannel.access$registerSelectSend(this.this$0, selectInstance, e, function2);
            }
        });
    }
    ...
    public final <R> void registerSelectSend(SelectInstance<? super R> selectInstance, E e, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
        if (selectInstance.trySelect()) {
            Closed it = offerInternal(e);
            if (it != null) {
                selectInstance.resumeSelectWithException(it.getSendException());
            } else {
