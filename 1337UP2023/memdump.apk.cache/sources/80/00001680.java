...
public final class AgentPremain {
    ...
    public static /* synthetic */ void $r8$lambda$8e1eAWGNJu9vYr96rU9gzKJ_uMQ(Signal signal) {
        m1627installSignalHandler$lambda1(signal);
    }
    ...
    static {
        ...
        try {
            ...
            m98constructorimpl = Result.m98constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m98constructorimpl = Result.m98constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m104isFailureimpl(m98constructorimpl) ? null : m98constructorimpl;
    ...
    public static final void m1627installSignalHandler$lambda1(Signal it) {
