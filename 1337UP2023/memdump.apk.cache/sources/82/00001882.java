...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        public Object prepare(AtomicOp<?> atomicOp) {
            ...
            if (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, mutexImpl, empty, prepare)) {
        ...
        public void complete(AtomicOp<?> atomicOp, Object failure) {
            ...
            AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, this.mutex, atomicOp, update);
        }
    }
