...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public static /* synthetic */ void m1599$r8$lambda$TOZof2GYGCn1P43qXNY1O5Gvm8(HandlerContext handlerContext, Runnable runnable) {
        m1600invokeOnTimeout$lambda3(handlerContext, runnable);
    }

    public static final /* synthetic */ Handler access$getHandler$p(HandlerContext $this) {
        return $this.handler;
    }
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, (long) DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.HandlerContext$$ExternalSyntheticLambda0
                ...
                public final void dispose() {
                    HandlerContext.m1599$r8$lambda$TOZof2GYGCn1P43qXNY1O5Gvm8(HandlerContext.this, block);
                }
            };
        }
        cancelOnRejection(context, block);
