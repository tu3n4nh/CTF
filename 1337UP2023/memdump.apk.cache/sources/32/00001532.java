...
public interface TimeMark {
    ...
    TimeMark mo1414minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1416plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1561plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1560minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1416plusLRDsOJo(Duration.m1476unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1457isNegativeimpl($this.mo1413elapsedNowUwyO8pc());
        }
