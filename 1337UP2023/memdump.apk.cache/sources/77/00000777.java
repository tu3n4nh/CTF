...
public final class ViewKt {
    public static /* synthetic */ void $r8$lambda$Y6wGMU_rQCvb5uOg5WbipwD8gCc(Function0 function0) {
        m35postOnAnimationDelayed$lambda1(function0);
    }
    ...
    public static final Runnable postOnAnimationDelayed(View $this$postOnAnimationDelayed, long delayInMillis, final Function0<Unit> action) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ViewKt.$r8$lambda$Y6wGMU_rQCvb5uOg5WbipwD8gCc(Function0.this);
            }
        };
    ...
    public static final void m35postOnAnimationDelayed$lambda1(Function0 action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }
