...
public class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final /* synthetic */ FileVisitResult access$copyToRecursively$copy(Function3 $copyAction, Path $this_copyToRecursively, Path $target, Function3 $onError, Path source, BasicFileAttributes attributes) {
        return copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt($copyAction, $this_copyToRecursively, $target, $onError, source, attributes);
    }
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$5.4
                    ...
                    public final FileVisitResult invoke(Path directory, IOException exception) {
                        ...
                        return PathsKt__PathRecursiveFunctionsKt.access$copyToRecursively$error(function3, path, path2, directory, exception);
                    }
                });
            }
