...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1652scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo1652scheduleResumeAfterDelay(j, cancellableContinuation);
    }
        ...
        while (true) {
            ...
            if (task != null) {
                ...
                if (fairnessCounter >= 16 && this.dispatcher.isDispatchNeeded(this)) {
                    this.dispatcher.mo1651dispatch(this, this);
                    return;
                }
            } else {
    ...
    private final void dispatchInternal(Runnable block, Function0<Unit> function0) {
        if (!addAndTryDispatching(block) && tryAllocateWorker()) {
            function0.invoke();
        }
    }
