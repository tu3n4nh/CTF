...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1413elapsedNowUwyO8pc() {
            return Duration.m1459minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark mo1416plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1460plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1415minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1429equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1456isInfiniteimpl(this.offset)) {
                return Duration.Companion.m1526getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1459minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1429equalsimpl0(mo1415minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m1526getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1452hashCodeimpl(Duration.m1460plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1473toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1526getZEROUwyO8pc(), null);
    }
}