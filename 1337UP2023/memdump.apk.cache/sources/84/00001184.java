...
public final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public static final /* synthetic */ void access$setResult$p(DeepRecursiveScopeImpl $this, Object obj) {
        $this.result = obj;
    }
    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            if (cont != null) {
                obj = DeepRecursiveKt.UNDEFINED_RESULT;
                if (!Result.m100equalsimpl0(obj, r)) {
                    ...
                    try {
                        ...
                        Object r2 = ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function3, 3)).invoke(this, obj3, cont);
                        if (r2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            Result.Companion companion = Result.Companion;
                            cont.resumeWith(Result.m98constructorimpl(r2));
                        }
                    } catch (Throwable e) {
                        Result.Companion companion2 = Result.Companion;
                        cont.resumeWith(Result.m98constructorimpl(ResultKt.createFailure(e)));
                    }
                }
            } else {
