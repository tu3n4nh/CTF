...
public class IntentSanitizer {
    ...
    public Intent sanitizeByFiltering(Intent in2) {
        return sanitize(in2, new Consumer() { // from class: androidx.core.content.IntentSanitizer$$ExternalSyntheticLambda0
    ...
    public Intent sanitizeByThrowing(Intent in2) {
        return sanitize(in2, new Consumer() { // from class: androidx.core.content.IntentSanitizer$$ExternalSyntheticLambda1
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
    ...
    public Intent sanitize(Intent in2, Consumer<String> penalty) {
        Intent intent = new Intent();
        ComponentName componentName = in2.getComponent();
        ...
        Api16Impl.sanitizeClipData(in2, intent, this.mAllowedClipData, this.mAllowClipDataText, this.mAllowedClipDataUri, penalty);
        if (Build.VERSION.SDK_INT >= 29) {
            if (this.mAllowIdentifier) {
                Api29Impl.setIdentifier(intent, Api29Impl.getIdentifier(in2));
            } else if (Api29Impl.getIdentifier(in2) != null) {
                penalty.accept("Identifier is not allowed: " + Api29Impl.getIdentifier(in2));
            }
        }
        if (this.mAllowSelector) {
            Api15Impl.setSelector(intent, Api15Impl.getSelector(in2));
        } else if (Api15Impl.getSelector(in2) != null) {
            penalty.accept("Selector is not allowed: " + Api15Impl.getSelector(in2));
        }
        if (this.mAllowSourceBounds) {
            intent.setSourceBounds(in2.getSourceBounds());
        } else if (in2.getSourceBounds() != null) {
            penalty.accept("SourceBounds is not allowed: " + in2.getSourceBounds());
        }
        return intent;
    }
    ...
    public static final class Builder {
        ...
        public Builder allowDataWithAuthority(final String authority) {
            ...
            allowData(new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda7
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.lambda$allowDataWithAuthority$8(authority, (Uri) obj);
                }
            });
            return this;
        }

        public static /* synthetic */ boolean lambda$allowDataWithAuthority$8(String authority, Uri v) {
        ...
        public Builder allowComponentWithPackage(final String packageName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda6
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.lambda$allowComponentWithPackage$9(packageName, (ComponentName) obj);
                }
            });
        }

        public static /* synthetic */ boolean lambda$allowComponentWithPackage$9(String packageName, ComponentName v) {
        ...
        public Builder allowClipDataUriWithAuthority(final String authority) {
            ...
            return allowClipDataUri(new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.lambda$allowClipDataUriWithAuthority$11(authority, (Uri) obj);
                }
            });
        }

        public static /* synthetic */ boolean lambda$allowClipDataUriWithAuthority$11(String authority, Uri v) {
            return authority.equals(v.getAuthority());
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(final String uriAuthority) {
            ...
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda3
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.lambda$allowExtraStreamUriWithAuthority$15(uriAuthority, (Uri) obj);
                }
            });
            return this;
        }

        public static /* synthetic */ boolean lambda$allowExtraStreamUriWithAuthority$15(String uriAuthority, Uri v) {
        ...
        public Builder allowExtraOutput(final String uriAuthority) {
            allowExtra("output", Uri.class, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda8
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.lambda$allowExtraOutput$16(uriAuthority, (Uri) obj);
                }
            });
            return this;
        }

        public static /* synthetic */ boolean lambda$allowExtraOutput$16(String uriAuthority, Uri v) {
            return uriAuthority.equals(v.getAuthority());
        }
    ...
    public static class Api16Impl {
        ...
        static void sanitizeClipData(Intent in2, Intent out, Predicate<ClipData> mAllowedClipData, boolean mAllowClipDataText, Predicate<Uri> mAllowedClipDataUri, Consumer<String> penalty) {
            ClipData clipData = in2.getClipData();
            if (clipData == null) {
                return;
            }
