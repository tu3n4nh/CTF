...
public final class SemaphoreImpl implements Semaphore {
    ...
    public SemaphoreImpl(int permits, int acquiredPermits) {
        ...
        if (!((acquiredPermits < 0 || acquiredPermits > permits) ? false : z)) {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
            ...
            while (true) {
                if (cur$iv$iv.getId() < id$iv || cur$iv$iv.getRemoved()) {
                    ...
                    if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                        m1654constructorimpl = SegmentOrClosed.m1654constructorimpl(ConcurrentLinkedListKt.CLOSED);
                        break;
                    }
                    ...
                    m1654constructorimpl = SegmentOrClosed.m1654constructorimpl(cur$iv$iv);
                    curTail = s$iv2;
                    break;
                }
            }
            s$iv = m1654constructorimpl;
            if (SegmentOrClosed.m1659isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1657getSegmentimpl(s$iv);
            while (true) {
                ...
                if (cur$iv$iv2.getId() >= to$iv$iv.getId()) {
                    ...
                    z = false;
                    break;
                } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(tail$FU, this, cur$iv$iv2, to$iv$iv)) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1657getSegmentimpl(s$iv);
        ...
        do {
            ...
            while (true) {
                ...
                if (cur$iv$iv2.getId() >= to$iv$iv.getId()) {
                    ...
                    continue;
                    break;
                } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(head$FU, this, cur$iv$iv2, to$iv$iv)) {
                    if (cur$iv$iv2.decPointers$kotlinx_coroutines_core()) {
                        cur$iv$iv2.remove();
                    }
                    z = true;
