...
public final class DurationKt {
    ...
    private static final long m1550timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1462timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1549timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1461timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }

    /* JADX WARN: Removed duplicated region for block: B:253:0x00c4 A[LOOP:1: B:242:0x0085->B:253:0x00c4, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:387:0x00df A[EDGE_INSN: B:387:0x00df->B:255:0x00df ?: BREAK  , SYNTHETIC] */
    /*
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1424constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1424constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1424constructorimpl((normalValue << 1) + unitDiscriminator);
    }
