...
public class EndCompoundLayout extends LinearLayout {
    ...
    public EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray a) {
        ...
        CheckableImageButton createIconView = createIconView(this, layoutInflater, R.id.text_input_error_icon);
        this.errorIconView = createIconView;
        CheckableImageButton createIconView2 = createIconView(frameLayout, layoutInflater, R.id.text_input_end_icon);
    ...
    public void setErrorIconTintMode(PorterDuff.Mode errorIconTintMode) {
        if (this.errorIconTintMode != errorIconTintMode) {
            ...
            IconHelper.applyIconTint(this.textInputLayout, this.errorIconView, this.errorIconTintList, errorIconTintMode);
        }
    }
    ...
    public void setEndIconTintList(ColorStateList endIconTintList) {
        if (this.endIconTintList != endIconTintList) {
            ...
            IconHelper.applyIconTint(this.textInputLayout, this.endIconView, endIconTintList, this.endIconTintMode);
        }
    }
    ...
    public void setEndIconTintMode(PorterDuff.Mode endIconTintMode) {
        if (this.endIconTintMode != endIconTintMode) {
            ...
            IconHelper.applyIconTint(this.textInputLayout, this.endIconView, this.endIconTintList, endIconTintMode);
        }
    }
