...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (newInstance != null) {
            m98constructorimpl = Result.m98constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            if (Result.m104isFailureimpl(m98constructorimpl)) {
                m98constructorimpl = null;
            }
            return (Function1) m98constructorimpl;
        }
    ...
    private final <R> List<R> dumpCoroutinesInfoImpl(final Function2<? super CoroutineOwner<?>, ? super CoroutineContext, ? extends R> function2) {
        ...
        try {
            ...
            Sequence $this$sortedBy$iv = CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines());
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo info) {
        ...
        for (StackTraceElement element : stackTraceElements) {
            StringBuilder append = new StringBuilder().append("\n                {\n                    \"declaringClass\": \"").append((Object) element.getClassName()).append("\",\n                    \"methodName\": \"").append((Object) element.getMethodName()).append("\",\n                    \"fileName\": ");
            String fileName = element.getFileName();
            stackTraceElementsInfoAsJson.add(StringsKt.trimIndent(append.append((Object) (fileName == null ? null : toStringWithQuotes(fileName))).append(",\n                    \"lineNumber\": ").append(element.getLineNumber()).append("\n                }\n                ").toString()));
        }
    ...
    public final List<DebugCoroutineInfo> dumpCoroutinesInfo() {
        ...
        try {
            ...
            Sequence $this$sortedBy$iv$iv = CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines());
            ...
            if (debugProbesImpl.isInstalled$kotlinx_coroutines_core()) {
                ...
                Sequence $this$sortedBy$iv = SequencesKt.filter(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new Function1<CoroutineOwner<?>, Boolean>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2
                    ...
                    public final Boolean invoke(DebugProbesImpl.CoroutineOwner<?> coroutineOwner) {
                        return Boolean.valueOf(!DebugProbesImpl.access$isFinished(DebugProbesImpl.INSTANCE, coroutineOwner));
                    }
                });
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            m98constructorimpl = Result.m98constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m98constructorimpl = Result.m98constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) m98constructorimpl;
        if (actualTrace == null) {
            return list;
        }
    ...
    private final <T extends Throwable> List<StackTraceElement> sanitizeStackTrace(T t) {
        ...
        if (!sanitizeStackTraces) {
            ...
            while (it2 < i2) {
                int i3 = it2 + 1;
                arrayList.add(it2 == 0 ? StackTraceRecoveryKt.artificialFrame(ARTIFICIAL_FRAME_MESSAGE) : stackTrace[it2 + probeIndex]);
                it2 = i3;
            }
            return arrayList;
        }
