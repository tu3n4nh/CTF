...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    */
            ...
            if (dependentView != null && ViewCompat.isLaidOut(dependentView)) {
                dependentView.post(new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        BottomAppBar.lambda$onLayout$0(dependentView);
                    }
                });
            }
        }
    ...
    public static /* synthetic */ void lambda$onLayout$0(View dependentView) {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel in2, ClassLoader loader) {
            super(in2, loader);
            this.fabAlignmentMode = in2.readInt();
            this.fabAttached = in2.readInt() != 0;
        }
