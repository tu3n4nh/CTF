...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1414minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo1415minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1416plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1419minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1416plusLRDsOJo(Duration.m1476unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1423compareToLRDsOJo($this.mo1415minusUwyO8pc(other), Duration.Companion.m1526getZEROUwyO8pc());
        }
    }
}