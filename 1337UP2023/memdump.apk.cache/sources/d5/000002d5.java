...
public class Motion implements TypedValues {
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        for (int i3 = 1; i3 < points.length; i3++) {
            points[i3].different(points[i3 - 1], mask2, this.mAttributeNames, arcMode2);
        }
        int count2 = 0;
        ...
        double[][] splineData = (double[][]) Array.newInstance(Double.TYPE, i6, this.mInterpolateVariables.length);
