...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public List<T> getReplayCache() {
        synchronized (this) {
            ...
            while (i < replaySize) {
                int i2 = i;
                i++;
                result.add(SharedFlowKt.access$getBufferAt(buffer, this.replayIndex + i2));
            }
            return result;
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r7v9, types: [kotlinx.coroutines.flow.SharedFlowSlot, java.lang.Object] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:36:0x00bd -> B:38:0x00c0). Please submit an issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static /* synthetic */ java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl r6, kotlinx.coroutines.flow.FlowCollector r7, kotlin.coroutines.Continuation r8) {
        /*
    ...
    private final Object[] growBuffer(Object[] curBuffer, int curSize, int newSize) {
        ...
        if (newSize > 0) {
            ...
            while (i < curSize) {
                int i2 = i;
                i++;
                SharedFlowKt.access$setBufferAt(newBuffer, i2 + head, SharedFlowKt.access$getBufferAt(curBuffer, i2 + head));
            }
            return newBuffer;
        }
