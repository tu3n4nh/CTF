...
final class FlowKt__DelayKt$sample$2$1$1 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m1634invokeWpGqRn0(channelResult.m1622unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1634invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$sample$2$1$1) create(ChannelResult.m1610boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                ?? m1622unboximpl = ((ChannelResult) this.L$0).m1622unboximpl();
                Ref.ObjectRef<Object> objectRef = this.$lastValue;
                if (!(m1622unboximpl instanceof ChannelResult.Failed)) {
                    objectRef.element = m1622unboximpl;
                }
                ReceiveChannel<Unit> receiveChannel = this.$ticker;
                Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
                if (m1622unboximpl instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m1614exceptionOrNullimpl(m1622unboximpl);
                    if (it != null) {
                        throw it;
                    }
