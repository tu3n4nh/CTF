...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$Z1vOW_gMqzuAA1kBf19jmX0gPxw(CancellableContinuation cancellableContinuation, long j) {
        m1601postFrameCallback$lambda6(cancellableContinuation, j);
    }

    public static final /* synthetic */ void access$updateChoreographerAndPostFrameCallback(CancellableContinuation cont) {
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.$r8$lambda$Z1vOW_gMqzuAA1kBf19jmX0gPxw(CancellableContinuation.this, j);
            }
        });
    }
