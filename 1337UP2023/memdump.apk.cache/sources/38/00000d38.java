...
public class KeylineStateList {
    ...
    private KeylineStateList(KeylineState defaultState, List<KeylineState> leftStateSteps, List<KeylineState> rightStateSteps) {
        ...
        float f = leftStateSteps.get(leftStateSteps.size() - 1).getFirstKeyline().loc - defaultState.getFirstKeyline().loc;
        this.leftShiftRange = f;
        float f2 = defaultState.getLastKeyline().loc - rightStateSteps.get(rightStateSteps.size() - 1).getLastKeyline().loc;
        this.rightShiftRange = f2;
        this.leftStateStepsInterpolationPoints = getStateStepInterpolationPoints(f, leftStateSteps, true);
        this.rightStateStepsInterpolationPoints = getStateStepInterpolationPoints(f2, rightStateSteps, false);
    }
