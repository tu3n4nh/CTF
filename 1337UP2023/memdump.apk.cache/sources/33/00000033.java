...
public final class ActivityResult implements Parcelable {
    public static final Parcelable.Creator<ActivityResult> CREATOR = new Parcelable.Creator<ActivityResult>() { // from class: androidx.activity.result.ActivityResult.1
        ...
        public ActivityResult createFromParcel(Parcel in2) {
            return new ActivityResult(in2);
        }
    ...
    ActivityResult(Parcel in2) {
        this.mResultCode = in2.readInt();
        this.mData = in2.readInt() == 0 ? null : (Intent) Intent.CREATOR.createFromParcel(in2);
    }
