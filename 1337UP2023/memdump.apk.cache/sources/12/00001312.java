...
public final class UProgressionUtilKt {
    ...
    private static final int m1316differenceModuloWZ9TVnA(int a, int b, int c) {
        int compare;
        ...
        return UInt.m193constructorimpl(compare >= 0 ? ac - bc : UInt.m193constructorimpl(ac - bc) + c);
    }

    /* renamed from: differenceModulo-sambcqE  reason: not valid java name */
    private static final long m1317differenceModulosambcqE(long a, long b, long c) {
        int compare;
        ...
        return ULong.m272constructorimpl(compare >= 0 ? ac - bc : ULong.m272constructorimpl(ac - bc) + c);
    }

    /* renamed from: getProgressionLastElement-Nkh28Cs  reason: not valid java name */
    public static final int m1319getProgressionLastElementNkh28Cs(int start, int end, int step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Integer.compare(start ^ Integer.MIN_VALUE, end ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return UInt.m193constructorimpl(end - m1316differenceModuloWZ9TVnA(end, start, UInt.m193constructorimpl(step)));
            }
        } else if (step >= 0) {
            ...
            if (compare > 0) {
                return UInt.m193constructorimpl(m1316differenceModuloWZ9TVnA(start, end, UInt.m193constructorimpl(-step)) + end);
            }
        }
        return end;
    }
    ...
    public static final long m1318getProgressionLastElement7ftBX0g(long start, long end, long step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Long.compare(start ^ Long.MIN_VALUE, end ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return ULong.m272constructorimpl(end - m1317differenceModulosambcqE(end, start, ULong.m272constructorimpl(step)));
            }
        } else if (step >= 0) {
            throw new IllegalArgumentException("Step is zero.");
        } else {
            ...
            if (compare > 0) {
                return ULong.m272constructorimpl(m1317differenceModulosambcqE(start, end, ULong.m272constructorimpl(-step)) + end);
            }
        }
        return end;
    }
