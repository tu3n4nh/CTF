        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m668contentEqualskV0jMPg(((UByteArray) t).m183unboximpl(), ((UByteArray) t2).m183unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m665contentEqualsFGO6Aew(((UShortArray) t).m446unboximpl(), ((UShortArray) t2).m446unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m666contentEqualsKJPZfPQ(((UIntArray) t).m262unboximpl(), ((UIntArray) t2).m262unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m670contentEqualslec5QzE(((ULongArray) t).m341unboximpl(), ((ULongArray) t2).m341unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m682contentToString2csIQuQ(uByteArray != null ? uByteArray.m183unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m686contentToStringd6D3K8(uShortArray != null ? uShortArray.m446unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m685contentToStringXUkPCBk(uIntArray != null ? uIntArray.m262unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m688contentToStringuLth9ew(uLongArray != null ? uLongArray.m341unboximpl() : null));
            } else {
