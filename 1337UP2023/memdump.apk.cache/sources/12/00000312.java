...
public interface TypedValues {
    ...
    public interface MotionType {
        ...
        static int getId(String name) {
            ...
            switch (name.hashCode()) {
                case -2033446275:
                    if (name.equals(S_ANIMATE_CIRCLEANGLE_TO)) {
                        c = 6;
                        break;
                    }
                    c = 65535;
                    break;
                case -1532277420:
                    if (name.equals(S_QUANTIZE_MOTION_PHASE)) {
                        c = 2;
                        break;
                    }
                    c = 65535;
                    break;
                case -1529145600:
                    if (name.equals(S_QUANTIZE_MOTIONSTEPS)) {
                        c = '\n';
                        break;
                    }
                    c = 65535;
                ...
                case -1498310144:
                    ...
                    break;
                case -1030753096:
                    if (name.equals(S_QUANTIZE_INTERPOLATOR)) {
                        c = 4;
                        break;
                    }
                    c = 65535;
                ...
                case -232872051:
                    ...
                    break;
                case 1138491429:
                    if (name.equals(S_POLAR_RELATIVETO)) {
                        c = '\t';
                        break;
                    }
                    c = 65535;
                    break;
                case 1539234834:
                    if (name.equals(S_QUANTIZE_INTERPOLATOR_TYPE)) {
                        c = 11;
                        break;
                    }
                    c = 65535;
                    break;
                case 1583722451:
                    if (name.equals(S_QUANTIZE_INTERPOLATOR_ID)) {
                        c = '\f';
                        break;
                    }
                    c = 65535;
                ...
                case 1639368448:
                    ...
                    break;
                case 1900899336:
                    if (name.equals(S_ANIMATE_RELATIVE_TO)) {
                        c = 5;
                        break;
                    }
                    c = 65535;
                    break;
                case 2109694967:
                    if (name.equals(S_PATHMOTION_ARC)) {
                        c = 7;
                        break;
                    }
                    c = 65535;
    ...
    public interface MotionScene {
        ...
        static int getId(String name) {
            ...
            switch (name.hashCode()) {
                case 6076149:
                    if (name.equals(S_DEFAULT_DURATION)) {
                        z = false;
                        break;
                    }
                    z = true;
                    break;
                case 1028758976:
                    if (name.equals(S_LAYOUT_DURING_TRANSITION)) {
                        z = true;
                        break;
                    }
                    z = true;
    ...
    public interface TransitionType {
        ...
        static int getId(String name) {
            ...
            switch (name.hashCode()) {
                case -1996906958:
                    if (name.equals(S_TRANSITION_FLAGS)) {
                        c = 7;
                        break;
                    }
                    c = 65535;
                ...
                case -1357874275:
                    ...
                    break;
                case -1298065308:
                    if (name.equals(S_AUTO_TRANSITION)) {
                        c = 4;
                        break;
                    }
                    c = 65535;
                ...
                case 3151786:
                    ...
                    break;
                case 1310733335:
                    if (name.equals(S_PATH_MOTION_ARC)) {
                        c = 3;
                        break;
                    }
                    c = 65535;
