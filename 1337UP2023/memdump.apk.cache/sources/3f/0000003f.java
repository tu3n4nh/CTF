...
public final class IntentSenderRequest implements Parcelable {
    public static final Parcelable.Creator<IntentSenderRequest> CREATOR = new Parcelable.Creator<IntentSenderRequest>() { // from class: androidx.activity.result.IntentSenderRequest.1
        ...
        public IntentSenderRequest createFromParcel(Parcel in2) {
            return new IntentSenderRequest(in2);
        }
    ...
    IntentSenderRequest(Parcel in2) {
        this.mIntentSender = (IntentSender) in2.readParcelable(IntentSender.class.getClassLoader());
        this.mFillInIntent = (Intent) in2.readParcelable(Intent.class.getClassLoader());
        this.mFlagsMask = in2.readInt();
        this.mFlagsValues = in2.readInt();
    }
