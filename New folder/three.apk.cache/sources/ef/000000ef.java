...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void initForMode(final ActionMode mode) {
        ...
        closeButton.setOnClickListener(new View.OnClickListener() { // from class: androidx.appcompat.widget.ActionBarContextView.1
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (view2 != null) {
            ...
            int customHeightMode = lp2.height == -2 ? Integer.MIN_VALUE : 1073741824;
