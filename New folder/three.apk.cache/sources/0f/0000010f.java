            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (convertView == null || convertView.getId() != 1) {
                        ...
                        TextView titleView = (TextView) convertView2.findViewById(R.id.title);
                        titleView.setText(ActivityChooserView.this.getContext().getString(R.string.abc_activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                }
