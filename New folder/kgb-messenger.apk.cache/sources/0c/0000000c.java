...
public class d {
    public static Interpolator a(Context context, int i) {
        ...
        try {
            try {
                try {
                    if (i == 17563663) {
                        a2 = new android.support.v4.h.b.a();
                    } else if (i == 17563661) {
                        a2 = new android.support.v4.h.b.b();
                        if (0 != 0) {
                            xmlResourceParser.close();
                        }
                    } else if (i == 17563662) {
                        a2 = new android.support.v4.h.b.c();
                        if (0 != 0) {
                            xmlResourceParser.close();
                        }
                    } else {
                        xmlResourceParser = context.getResources().getAnimation(i);
                        a2 = a(context, context.getResources(), context.getTheme(), xmlResourceParser);
    ...
    */
    private static android.view.animation.Interpolator a(android.content.Context r4, android.content.res.Resources r5, android.content.res.Resources.Theme r6, org.xmlpull.v1.XmlPullParser r7) {
        /*
            r0 = 0
            int r1 = r7.getDepth()
        L5:
        ...
        La0:
            ...
            if (r0 == 0) goto Laf
            android.support.a.a.g r0 = new android.support.a.a.g
            r0.<init>(r4, r2, r7)
            goto L5
        Laf:
        ...
        Lcc:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.a.a.d.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}