...
class w {
    ...
    public static void a(View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        ac.a(view, new Runnable() { // from class: android.support.v4.b.w.3
    ...
    public static void a(View view, final ArrayList<View> arrayList, final Map<String, String> map) {
        ac.a(view, new Runnable() { // from class: android.support.v4.b.w.4
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
                    ...
                    String transitionName = view2.getTransitionName();
                    if (transitionName != null) {
                        view2.setTransitionName(w.b(map, transitionName));
                    }
                }
            }
        });
    ...
    public static void a(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        ac.a(viewGroup, new Runnable() { // from class: android.support.v4.b.w.7
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
    ...
    public static void a(Object obj, final Rect rect) {
        if (obj != null) {
            ((Transition) obj).setEpicenterCallback(new Transition.EpicenterCallback() { // from class: android.support.v4.b.w.6
    ...
    public static void a(Object obj, View view) {
        if (view != null) {
            ...
            a(view, rect);
            ((Transition) obj).setEpicenterCallback(new Transition.EpicenterCallback() { // from class: android.support.v4.b.w.1
                @Override // android.transition.Transition.EpicenterCallback
                public Rect onGetEpicenter(Transition transition) {
                    return rect;
                }
    ...
    public static void a(Object obj, View view, ArrayList<View> arrayList) {
    ...
    public static void a(Object obj, final Object obj2, final ArrayList<View> arrayList, final Object obj3, final ArrayList<View> arrayList2, final Object obj4, final ArrayList<View> arrayList3) {
        ((Transition) obj).addListener(new Transition.TransitionListener() { // from class: android.support.v4.b.w.5
            ...
            public void onTransitionStart(Transition transition) {
                if (obj2 != null) {
                    w.b(obj2, (ArrayList<View>) arrayList, (ArrayList<View>) null);
                }
                if (obj3 != null) {
                    w.b(obj3, (ArrayList<View>) arrayList2, (ArrayList<View>) null);
                }
                if (obj4 != null) {
                    w.b(obj4, (ArrayList<View>) arrayList3, (ArrayList<View>) null);
                }
            }
        });
    }
    ...
    public static Object b(Object obj, Object obj2, Object obj3) {
    ...
    public static void b(Object obj, final View view, final ArrayList<View> arrayList) {
        ((Transition) obj).addListener(new Transition.TransitionListener() { // from class: android.support.v4.b.w.2
            @Override // android.transition.Transition.TransitionListener
            public void onTransitionCancel(Transition transition) {
            }
    ...
    public static void b(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        List<View> targets;
        Transition transition = (Transition) obj;
        if (transition instanceof TransitionSet) {
            TransitionSet transitionSet = (TransitionSet) transition;
