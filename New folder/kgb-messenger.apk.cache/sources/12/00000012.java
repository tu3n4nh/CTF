...
class h {
    ...
    public static class b {
        ...
        b(b bVar) {
            this.f13a = bVar.f13a;
            this.b = h.a(bVar.b, 0, bVar.b.length);
        }
        ...
        private static void a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            switch (c2) {
                ...
                case a.j.AppCompatTheme_windowMinWidthMajor /* 113 */:
        ...
        public static void a(b[] bVarArr, Path path) {
            ...
            for (int i = 0; i < bVarArr.length; i++) {
                a(path, fArr, c, bVarArr[i].f13a, bVarArr[i].b);
                c = bVarArr[i].f13a;
            }
        }
    ...
    public static boolean a(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f13a != bVarArr2[i].f13a || bVarArr[i].b.length != bVarArr2[i].b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void b(b[] bVarArr, b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f13a = bVarArr2[i].f13a;
