...
public class r extends MultiAutoCompleteTextView implements android.support.v4.h.ab {

    /* renamed from: a  reason: collision with root package name */
    private static final int[] f429a = {16843126};
    private final h b;
    private final z c;
    ...
    public r(Context context, AttributeSet attributeSet, int i) {
        ...
        bg a2 = bg.a(getContext(), attributeSet, f429a, i, 0);
        if (a2.g(0)) {
