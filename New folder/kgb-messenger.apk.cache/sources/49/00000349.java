...
class t {
    ...
    private static final int[] f432a = {16843067, 16843068};
    ...
    private Drawable a(Drawable drawable, boolean z) {
        if (drawable instanceof android.support.v4.d.a.h) {
            Drawable a2 = ((android.support.v4.d.a.h) drawable).a();
            if (a2 != null) {
                ((android.support.v4.d.a.h) drawable).a(a(a2, z));
            }
    ...
    public void a(AttributeSet attributeSet, int i) {
        bg a2 = bg.a(this.b.getContext(), attributeSet, f432a, i, 0);
        Drawable b = a2.b(0);
        if (b != null) {
