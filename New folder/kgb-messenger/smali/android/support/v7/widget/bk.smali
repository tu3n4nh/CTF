...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bk;->a:Landroid/support/v4/g/a;

    new-instance v0, Landroid/support/v4/g/f;

    invoke-direct {v0}, Landroid/support/v4/g/f;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/bk;->b:Landroid/support/v4/g/f;
...
.method private a(Landroid/support/v7/widget/RecyclerView$w;I)Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bk;->a:Landroid/support/v4/g/a;
    ...
    iget v3, v0, Landroid/support/v7/widget/bk$a;->a:I

    and-int/2addr v3, p2

    if-eqz v3, :cond_0

    iget v1, v0, Landroid/support/v7/widget/bk$a;->a:I

    xor-int/lit8 v3, p2, -0x1

    and-int/2addr v1, v3

    iput v1, v0, Landroid/support/v7/widget/bk$a;->a:I

    const/4 v1, 0x4

    if-ne p2, v1, :cond_2

    iget-object v1, v0, Landroid/support/v7/widget/bk$a;->b:Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/bk;->a:Landroid/support/v4/g/a;

    invoke-virtual {v3, v2}, Landroid/support/v4/g/a;->d(I)Ljava/lang/Object;

    invoke-static {v0}, Landroid/support/v7/widget/bk$a;->a(Landroid/support/v7/widget/bk$a;)V
    ...
    iget-object v1, v0, Landroid/support/v7/widget/bk$a;->c:Landroid/support/v7/widget/RecyclerView$e$c;
...
.method a(J)Landroid/support/v7/widget/RecyclerView$w;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bk;->b:Landroid/support/v4/g/f;
...
.method a(Landroid/support/v7/widget/RecyclerView$w;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bk;->a:Landroid/support/v4/g/a;

    invoke-virtual {v1, p1, v0}, Landroid/support/v4/g/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iput-object p2, v0, Landroid/support/v7/widget/bk$a;->b:Landroid/support/v7/widget/RecyclerView$e$c;
...
.method a(Landroid/support/v7/widget/bk$b;)V
    .locals 5
    ...
    iget v3, v1, Landroid/support/v7/widget/bk$a;->a:I
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/widget/bk$b;->a(Landroid/support/v7/widget/RecyclerView$w;)V
    ...
    iget-object v3, v1, Landroid/support/v7/widget/bk$a;->b:Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    iget-object v4, v1, Landroid/support/v7/widget/bk$a;->c:Landroid/support/v7/widget/RecyclerView$e$c;

    invoke-interface {p1, v0, v3, v4}, Landroid/support/v7/widget/bk$b;->a(Landroid/support/v7/widget/RecyclerView$w;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    invoke-interface {p1, v0, v3, v4}, Landroid/support/v7/widget/bk$b;->b(Landroid/support/v7/widget/RecyclerView$w;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    invoke-interface {p1, v0, v3, v4}, Landroid/support/v7/widget/bk$b;->c(Landroid/support/v7/widget/RecyclerView$w;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
...
.method a(Landroid/support/v7/widget/RecyclerView$w;)Z
    ...
    iget v0, v0, Landroid/support/v7/widget/bk$a;->a:I
...
.method b(Landroid/support/v7/widget/RecyclerView$w;)Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/bk;->a(Landroid/support/v7/widget/RecyclerView$w;I)Landroid/support/v7/widget/RecyclerView$e$c;
...
.method b()V
    ...
    invoke-static {}, Landroid/support/v7/widget/bk$a;->b()V
...
.method c(Landroid/support/v7/widget/RecyclerView$w;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    :cond_0
    iput-object p2, v0, Landroid/support/v7/widget/bk$a;->c:Landroid/support/v7/widget/RecyclerView$e$c;
...
.method g(Landroid/support/v7/widget/RecyclerView$w;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bk;->b:Landroid/support/v4/g/f;
...
.method public h(Landroid/support/v7/widget/RecyclerView$w;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bk;->f(Landroid/support/v7/widget/RecyclerView$w;)V
