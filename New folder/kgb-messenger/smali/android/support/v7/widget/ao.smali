...
.method private f()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;
    ...
    :goto_0
    invoke-virtual {p0, v5, v0}, Landroid/support/v7/widget/ao;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/ah;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ah;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ah;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    iget-object v6, p0, Landroid/support/v7/widget/ao;->z:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ah;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ah;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    iget-object v6, p0, Landroid/support/v7/widget/ao;->C:Landroid/support/v7/widget/ao$c;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ah;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/ah;->a(IIIII)I

    move-result v0

    if-lez v0, :cond_9

    iget-object v1, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v1}, Landroid/support/v7/widget/ah;->getPaddingTop()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v2}, Landroid/support/v7/widget/ah;->getPaddingBottom()I
...
.method public a()V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/ao;->f()I
    ...
    invoke-static {v0, v4}, Landroid/support/v4/widget/r;->a(Landroid/widget/PopupWindow;I)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Landroid/support/v4/widget/r;->a(Landroid/widget/PopupWindow;Landroid/view/View;III)V

    iget-object v0, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ah;->setSelection(I)V
...
.method public c()V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;
...
.method public i(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ah;->setSelection(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ah;->getChoiceMode()I
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/ah;->setItemChecked(IZ)V
