...
.field private final B:Landroid/support/v4/h/y;

.field a:Landroid/support/v7/widget/ActionBarContainer;

.field b:Z

.field c:Landroid/support/v4/h/as;

.field final d:Landroid/support/v4/h/aw;
...
.field private y:Landroid/support/v4/widget/w;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v4/h/aw;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/h/y;
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/widget/w;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/widget/w;
...
.method public a(I)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ae;->f()V
...
.method d()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->c:Landroid/support/v4/h/as;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/h/ae;->k(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/h/ae;->q(Landroid/view/View;)I
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/widget/bl;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/h/ae;->k(Landroid/view/View;)F
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/h/y;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/ae;->r(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v9, v2}, Landroid/support/v7/widget/bl;->a(II)I
