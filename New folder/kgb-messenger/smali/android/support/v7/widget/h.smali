...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/h;->f:Landroid/support/v7/widget/be;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/v7/widget/be;

    invoke-direct {v1}, Landroid/support/v7/widget/be;-><init>()V

    iput-object v1, p0, Landroid/support/v7/widget/h;->f:Landroid/support/v7/widget/be;

    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/h;->f:Landroid/support/v7/widget/be;

    invoke-virtual {v1}, Landroid/support/v7/widget/be;->a()V

    iget-object v2, p0, Landroid/support/v7/widget/h;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/h/ae;->u(Landroid/view/View;)Landroid/content/res/ColorStateList;

    move-result-object v2

    if-eqz v2, :cond_1

    iput-boolean v0, v1, Landroid/support/v7/widget/be;->d:Z

    iput-object v2, v1, Landroid/support/v7/widget/be;->a:Landroid/content/res/ColorStateList;

    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/h;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/h/ae;->v(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    if-eqz v2, :cond_2

    iput-boolean v0, v1, Landroid/support/v7/widget/be;->c:Z

    iput-object v2, v1, Landroid/support/v7/widget/be;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/be;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/be;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/be;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/h/ae;->a(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/h/ae;->a(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method c()V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/be;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/be;[I)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/be;
