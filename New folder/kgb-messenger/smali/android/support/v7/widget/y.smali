...
# interfaces
.implements Landroid/support/v4/h/ab;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->c:Landroid/content/Context;
    ...
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/y;->a:[I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->c:Landroid/content/Context;
    ...
    iput v5, p0, Landroid/support/v7/widget/y;->h:I
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/bg;->a()V

    iput-object v0, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/y$b;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/aj;

    :cond_2
    sget v0, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/bg;->f(I)[Ljava/lang/CharSequence;
    ...
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/bg;->a()V

    iput-boolean v3, p0, Landroid/support/v7/widget/y;->f:Z

    iget-object v0, p0, Landroid/support/v7/widget/y;->e:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/y;->e:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->c:Landroid/content/Context;
...
.method static synthetic b(Landroid/support/v7/widget/y;)Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->i:Landroid/graphics/Rect;
...
.method a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/y;->i:Landroid/graphics/Rect;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/aj;
