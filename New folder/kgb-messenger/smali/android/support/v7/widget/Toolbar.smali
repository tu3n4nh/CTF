...
.field private u:Landroid/support/v7/widget/aw;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/bg;->g(I)Z
    ...
    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/aw;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/aw;->b(II)V
    ...
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/aw;

    invoke-virtual {v3, v0, v2}, Landroid/support/v7/widget/aw;->a(II)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bg;->g(I)Z
    ...
    :cond_e
    invoke-virtual {v1}, Landroid/support/v7/widget/bg;->a()V
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p2, v3}, Landroid/support/v4/h/f;->a(II)I
...
.method private b(I)I
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/f;->a(II)I
...
.method private b(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v4/h/o;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v1

    invoke-static {v0}, Landroid/support/v4/h/o;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private s()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/aw;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/aw;
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/aw;->a(II)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/ae;->n(Landroid/view/View;)I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/support/v4/h/ae;->i(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/widget/bl;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/h/ae;->i(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/widget/bl;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/widget/bl;->a(II)I
    ...
    invoke-static {v11, v4}, Landroid/support/v7/widget/bl;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/h/ae;->i(Landroid/view/View;)I

    move-result v2

    invoke-static {v11, v2}, Landroid/support/v7/widget/bl;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/h/ae;->a(III)I
    ...
    invoke-static {v0, p2, v2}, Landroid/support/v4/h/ae;->a(III)I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-static {v0}, Landroid/support/v4/h/q;->b(Landroid/view/MenuItem;)Z
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/aw;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/aw;->a(Z)V
