...
.method constructor <init>(Landroid/support/v7/widget/bj$b;)V
    ...
    invoke-direct {v0}, Landroid/support/v7/widget/bj$a;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;
...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bj$b;->b()I
    ...
    invoke-interface {v1, p1}, Landroid/support/v7/widget/bj$b;->a(I)Landroid/view/View;

    move-result-object v1

    iget-object v5, p0, Landroid/support/v7/widget/bj;->a:Landroid/support/v7/widget/bj$b;

    invoke-interface {v5, v1}, Landroid/support/v7/widget/bj$b;->a(Landroid/view/View;)I

    move-result v5

    iget-object v6, p0, Landroid/support/v7/widget/bj;->a:Landroid/support/v7/widget/bj$b;

    invoke-interface {v6, v1}, Landroid/support/v7/widget/bj$b;->b(Landroid/view/View;)I

    move-result v6

    iget-object v7, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;

    invoke-virtual {v7, v3, v4, v5, v6}, Landroid/support/v7/widget/bj$a;->a(IIII)V

    if-eqz p3, :cond_1

    iget-object v5, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;

    invoke-virtual {v5}, Landroid/support/v7/widget/bj$a;->a()V

    iget-object v5, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;

    invoke-virtual {v5, p3}, Landroid/support/v7/widget/bj$a;->a(I)V

    iget-object v5, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;

    invoke-virtual {v5}, Landroid/support/v7/widget/bj$a;->b()Z
...
.method a(Landroid/view/View;I)Z
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/support/v7/widget/bj$a;->a(IIII)V

    if-eqz p2, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;

    invoke-virtual {v0}, Landroid/support/v7/widget/bj$a;->a()V

    iget-object v0, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;

    invoke-virtual {v0, p2}, Landroid/support/v7/widget/bj$a;->a(I)V

    iget-object v0, p0, Landroid/support/v7/widget/bj;->b:Landroid/support/v7/widget/bj$a;

    invoke-virtual {v0}, Landroid/support/v7/widget/bj$a;->b()Z
