...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p4}, Landroid/support/v7/widget/ag;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_0
    invoke-static {p4}, Landroid/support/v4/d/a/a;->f(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bb;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v1}, Landroid/support/v7/widget/bb;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bb;->c(Landroid/content/Context;I)I
...
.method private static a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/ag;->b(Landroid/graphics/drawable/Drawable;)Z
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/be;[I)V
    ...
    :goto_1
    iget-boolean v1, p1, Landroid/support/v7/widget/be;->c:Z

    if-eqz v1, :cond_4

    iget-object v1, p1, Landroid/support/v7/widget/be;->b:Landroid/graphics/PorterDuff$Mode;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p2}, Landroid/support/v7/widget/ag;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_0
    invoke-static {p0, v4}, Landroid/support/v7/widget/bb;->a(Landroid/content/Context;I)I
...
.method private static a(Landroid/graphics/drawable/Drawable;)Z
    ...
    instance-of v0, p0, Landroid/support/a/a/k;
...
.method private b(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bb;->a(Landroid/content/Context;I)I
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/g/l;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/g/l;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/g/l;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/m;->l:Landroid/support/v4/g/l;
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/bb;->a(Landroid/content/Context;I)I

    move-result v3

    sget v4, Landroid/support/v7/a/a$a;->colorButtonNormal:I

    invoke-static {p1, v4}, Landroid/support/v7/widget/bb;->c(Landroid/content/Context;I)I

    move-result v4

    sget-object v5, Landroid/support/v7/widget/bb;->a:[I
    ...
    sget-object v4, Landroid/support/v7/widget/bb;->d:[I

    aput-object v4, v0, v2

    invoke-static {v3, p2}, Landroid/support/v4/d/a;->a(II)I
    ...
    sget-object v4, Landroid/support/v7/widget/bb;->b:[I
    ...
    sget-object v3, Landroid/support/v7/widget/bb;->h:[I
...
.method a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2}, Landroid/support/v4/c/a;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/ag;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_3
    return-object v0
.end method

.method a(Landroid/content/Context;Landroid/support/v7/widget/bi;I)Landroid/graphics/drawable/Drawable;
    .locals 2
...
.method b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bb;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
