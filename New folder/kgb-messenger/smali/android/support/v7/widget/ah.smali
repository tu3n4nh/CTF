...
.field private j:Landroid/support/v4/h/as;
...
.method private a(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ah;->getItemIdAtPosition(I)J

    move-result-wide v0

    invoke-virtual {p0, p1, p2, v0, v1}, Landroid/support/v7/widget/ah;->performItemClick(Landroid/view/View;IJ)Z
...
.method private a(Landroid/view/View;IFF)V
    ...
    iput-boolean v3, p0, Landroid/support/v7/widget/ah;->i:Z

    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I

    if-lt v0, v5, :cond_0

    invoke-virtual {p0, p3, p4}, Landroid/support/v7/widget/ah;->drawableHotspotChanged(FF)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/ah;->setPressed(Z)V
    ...
    :cond_2
    iput p2, p0, Landroid/support/v7/widget/ah;->f:I
    ...
    :cond_4
    invoke-virtual {p0, p2, p1, p3, p4}, Landroid/support/v7/widget/ah;->a(ILandroid/view/View;FF)V

    invoke-virtual {p0, v4}, Landroid/support/v7/widget/ah;->setSelectorEnabled(Z)V
...
.method private d()V
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/ah;->i:Z

    invoke-virtual {p0, v2}, Landroid/support/v7/widget/ah;->setPressed(Z)V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ah;->j:Landroid/support/v4/h/as;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ah;->j:Landroid/support/v4/h/as;
...
.method public a(Landroid/view/MotionEvent;I)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ah;->k:Landroid/support/v4/widget/n;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ah;->k:Landroid/support/v4/widget/n;
    ...
    invoke-virtual {p0, v5, v4}, Landroid/support/v7/widget/ah;->pointToPosition(II)I
    ...
    invoke-direct {p0, v0, v6, v5, v4}, Landroid/support/v7/widget/ah;->a(Landroid/view/View;IFF)V

    if-ne v3, v2, :cond_0

    invoke-direct {p0, v0, v6}, Landroid/support/v7/widget/ah;->a(Landroid/view/View;I)V
...
.method public isInTouchMode()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ah;->g:Z
