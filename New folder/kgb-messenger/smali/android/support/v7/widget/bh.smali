...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Z)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Landroid/support/v7/widget/bh;-><init>(Landroid/support/v7/widget/Toolbar;ZII)V
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/bh;->q:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_d

    sget v2, Landroid/support/v7/a/a$j;->ActionBar_title:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/bg;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bh;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bh;->c(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bh;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bh;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_3
    iget-object v2, p0, Landroid/support/v7/widget/bh;->j:Landroid/graphics/drawable/Drawable;

    if-nez v2, :cond_4

    iget-object v2, p0, Landroid/support/v7/widget/bh;->q:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_4

    iget-object v2, p0, Landroid/support/v7/widget/bh;->q:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bh;->c(Landroid/graphics/drawable/Drawable;)V

    :cond_4
    sget v2, Landroid/support/v7/a/a$j;->ActionBar_displayOptions:I

    invoke-virtual {v0, v2, v1}, Landroid/support/v7/widget/bg;->a(II)I

    move-result v2

    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bh;->c(I)V

    sget v2, Landroid/support/v7/a/a$j;->ActionBar_customNavigationLayout:I

    invoke-virtual {v0, v2, v1}, Landroid/support/v7/widget/bg;->g(II)I

    move-result v2

    if-eqz v2, :cond_5

    iget-object v3, p0, Landroid/support/v7/widget/bh;->a:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bh;->a(Landroid/view/View;)V

    iget v2, p0, Landroid/support/v7/widget/bh;->e:I
    ...
    invoke-virtual {v0, v2, v1}, Landroid/support/v7/widget/bg;->f(II)I
    ...
    invoke-virtual {v0, v2, v5}, Landroid/support/v7/widget/bg;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/a/a$j;->ActionBar_contentInsetEnd:I

    invoke-virtual {v0, v3, v5}, Landroid/support/v7/widget/bg;->d(II)I
    ...
    invoke-virtual {p0, p3}, Landroid/support/v7/widget/bh;->e(I)V
    ...
    :cond_d
    invoke-direct {p0}, Landroid/support/v7/widget/bh;->s()I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/bh;->e:I
...
# virtual methods
.method public a(IJ)Landroid/support/v4/h/as;
    .locals 2
    ...
    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v4/h/as;->a(F)Landroid/support/v4/h/as;

    move-result-object v0

    invoke-virtual {v0, p2, p3}, Landroid/support/v4/h/as;->a(J)Landroid/support/v4/h/as;
...
.method public a(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/bh;->b()Landroid/content/Context;
...
.method public a(Landroid/support/v7/widget/ay;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ay;->setAllowCollapse(Z)V
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bh;->e(Ljava/lang/CharSequence;)V
...
.method public c(I)V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/bh;->v()V

    :cond_0
    invoke-direct {p0}, Landroid/support/v7/widget/bh;->u()V
...
.method public d(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/bh;->m:Ljava/lang/CharSequence;
...
.method public e(I)V
    ...
    :cond_1
    iput p1, p0, Landroid/support/v7/widget/bh;->p:I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bh;->f(I)V
...
.method public f(I)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bh;->d(Ljava/lang/CharSequence;)V
