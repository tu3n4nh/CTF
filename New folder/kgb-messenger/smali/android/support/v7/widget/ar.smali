...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/ao;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method a(Landroid/content/Context;Z)Landroid/support/v7/widget/ah;
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/ar$a;-><init>(Landroid/content/Context;Z)V

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ar$a;->setHoverListener(Landroid/support/v7/widget/aq;)V
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/aq;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    :cond_0
    return-void
.end method

.method public a(Landroid/support/v7/widget/aq;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ar;->b:Landroid/support/v7/widget/aq;
...
.method public b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/aq;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
