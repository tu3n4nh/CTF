...
.field final p:Landroid/support/v4/h/aw;

.field final q:Landroid/support/v4/h/aw;

.field final r:Landroid/support/v4/h/ay;
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/r;->p:Landroid/support/v4/h/aw;
    ...
    iput-object v0, p0, Landroid/support/v7/app/r;->q:Landroid/support/v4/h/aw;
    ...
    iput-object v0, p0, Landroid/support/v7/app/r;->r:Landroid/support/v4/h/ay;
...
.method private a(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/r;->b(Landroid/view/View;)Landroid/support/v7/widget/ae;
...
.method private k(Z)V
    ...
    iget-object v3, p0, Landroid/support/v7/app/r;->g:Landroid/support/v7/widget/ay;
    ...
    invoke-static {v3}, Landroid/support/v4/h/ae;->r(Landroid/view/View;)V
...
.method private r()Z
    ...
    invoke-static {v0}, Landroid/support/v4/h/ae;->x(Landroid/view/View;)Z
...
.method public a(F)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/h/ae;->d(Landroid/view/View;F)V
...
.method public h(Z)V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/h/ae;->b(Landroid/view/View;F)V
    ...
    invoke-static {v1, v0}, Landroid/support/v4/h/ae;->b(Landroid/view/View;F)V
    ...
    invoke-static {v2}, Landroid/support/v4/h/ae;->o(Landroid/view/View;)Landroid/support/v4/h/as;
    ...
    iget-object v3, p0, Landroid/support/v7/app/r;->r:Landroid/support/v4/h/ay;

    invoke-virtual {v2, v3}, Landroid/support/v4/h/as;->a(Landroid/support/v4/h/ay;)Landroid/support/v4/h/as;

    invoke-virtual {v1, v2}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/as;)Landroid/support/v7/view/h;
    ...
    invoke-static {v2, v0}, Landroid/support/v4/h/ae;->b(Landroid/view/View;F)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/h/as;->c(F)Landroid/support/v4/h/as;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/as;)Landroid/support/v7/view/h;
    ...
    iget-object v0, p0, Landroid/support/v7/app/r;->q:Landroid/support/v4/h/aw;

    invoke-virtual {v1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/aw;)Landroid/support/v7/view/h;
    ...
    invoke-static {v0}, Landroid/support/v4/h/ae;->r(Landroid/view/View;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/h/aw;->b(Landroid/view/View;)V
...
.method public i(Z)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/h/as;->c(F)Landroid/support/v4/h/as;
    ...
    iget-object v0, p0, Landroid/support/v7/app/r;->p:Landroid/support/v4/h/aw;
...
.method public j(Z)V
    ...
    invoke-interface {v0, v1, v4, v5}, Landroid/support/v7/widget/ae;->a(IJ)Landroid/support/v4/h/as;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v7/app/r;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v1, v2, v6, v7}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/h/as;
    ...
    invoke-virtual {v2, v0, v1}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/as;Landroid/support/v4/h/as;)Landroid/support/v7/view/h;
    ...
    invoke-interface {v0, v2, v6, v7}, Landroid/support/v7/widget/ae;->a(IJ)Landroid/support/v4/h/as;

    move-result-object v1

    iget-object v0, p0, Landroid/support/v7/app/r;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v0, v3, v4, v5}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/h/as;
