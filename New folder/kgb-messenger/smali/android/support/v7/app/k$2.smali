...
.method public a(Landroid/view/View;Landroid/support/v4/h/az;)Landroid/support/v4/h/az;
    ...
    invoke-virtual {p2}, Landroid/support/v4/h/az;->b()I
    ...
    invoke-virtual {p2}, Landroid/support/v4/h/az;->a()I

    move-result v0

    invoke-virtual {p2}, Landroid/support/v4/h/az;->c()I

    move-result v2

    invoke-virtual {p2}, Landroid/support/v4/h/az;->d()I

    move-result v3

    invoke-virtual {p2, v0, v1, v2, v3}, Landroid/support/v4/h/az;->a(IIII)Landroid/support/v4/h/az;

    move-result-object p2

    :cond_0
    invoke-static {p1, p2}, Landroid/support/v4/h/ae;->a(Landroid/view/View;Landroid/support/v4/h/az;)Landroid/support/v4/h/az;
