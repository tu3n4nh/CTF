...
.field q:Landroid/support/v4/h/as;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/d;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/k;->q:Landroid/support/v4/h/as;
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ad;
    ...
    invoke-static {v0}, Landroid/support/v4/h/ao;->a(Landroid/view/ViewConfiguration;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ad;
...
.method private b(Landroid/support/v7/app/k$d;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ad;
...
.method private d(I)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/h/ae;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private x()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ad;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/h/ae;->a(Landroid/view/View;Landroid/support/v4/h/z;)V
...
.method a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    invoke-static {v5, v6}, Landroid/support/v4/widget/r;->a(Landroid/widget/PopupWindow;I)V
    ...
    invoke-virtual {v0, v7}, Landroid/support/v4/h/as;->a(F)Landroid/support/v4/h/as;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/k;->q:Landroid/support/v4/h/as;

    iget-object v0, p0, Landroid/support/v7/app/k;->q:Landroid/support/v4/h/as;
    ...
    invoke-static {v0, v7}, Landroid/support/v4/h/ae;->c(Landroid/view/View;F)V
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Landroid/support/v4/b/z;->b(Landroid/app/Activity;)Ljava/lang/String;
...
.method public h()V
    ...
    invoke-static {v0, p0}, Landroid/support/v4/h/j;->a(Landroid/view/LayoutInflater;Landroid/support/v4/h/n;)V
    ...
    :cond_1
    invoke-static {v0}, Landroid/support/v4/h/j;->a(Landroid/view/LayoutInflater;)Landroid/support/v4/h/n;
