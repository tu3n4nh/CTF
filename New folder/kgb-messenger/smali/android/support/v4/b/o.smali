...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/b/y;
    ...
    iget-object v0, p0, Landroid/support/v4/b/o;->f:Landroid/support/v4/g/k;
    ...
    iput-object v0, p0, Landroid/support/v4/b/o;->f:Landroid/support/v4/g/k;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/b/y;-><init>(Ljava/lang/String;Landroid/support/v4/b/o;Z)V

    iget-object v1, p0, Landroid/support/v4/b/o;->f:Landroid/support/v4/g/k;
    ...
    iget-boolean v1, v0, Landroid/support/v4/b/y;->e:Z
...
.method a(Landroid/support/v4/g/k;)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/b/y;->a(Landroid/support/v4/b/o;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/b/o;->f:Landroid/support/v4/g/k;
...
.method a(Z)V
    ...
    iget-object v0, p0, Landroid/support/v4/b/o;->h:Landroid/support/v4/b/y;
...
.method k()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/b/o;->a(Ljava/lang/String;ZZ)Landroid/support/v4/b/y;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/b/o;->h:Landroid/support/v4/b/y;
...
.method n()Landroid/support/v4/g/k;
    ...
    iget-boolean v6, v5, Landroid/support/v4/b/y;->f:Z

    if-nez v6, :cond_2

    if-eqz v2, :cond_2

    iget-boolean v6, v5, Landroid/support/v4/b/y;->e:Z

    if-nez v6, :cond_1

    invoke-virtual {v5}, Landroid/support/v4/b/y;->b()V

    :cond_1
    invoke-virtual {v5}, Landroid/support/v4/b/y;->d()V
    ...
    :cond_3
    invoke-virtual {v5}, Landroid/support/v4/b/y;->h()V

    iget-object v6, p0, Landroid/support/v4/b/o;->f:Landroid/support/v4/g/k;

    iget-object v5, v5, Landroid/support/v4/b/y;->d:Ljava/lang/String;
