.class Landroid/support/v4/b/z$b;
...
.method public a(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    invoke-static {p1}, Landroid/support/v4/b/z;->b(Landroid/app/Activity;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p1, v2}, Landroid/support/v4/b/z;->b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;

    move-result-object v3

    if-nez v3, :cond_1

    invoke-static {v2}, Landroid/support/v4/c/f;->a(Landroid/content/ComponentName;)Landroid/content/Intent;
