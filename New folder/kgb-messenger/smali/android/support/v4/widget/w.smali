...
.method constructor <init>(ZLandroid/content/Context;Landroid/view/animation/Interpolator;)V
    ...
    iput-boolean p1, p0, Landroid/support/v4/widget/w;->b:Z
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v4/widget/w;->a:Landroid/widget/OverScroller;
...
.method public static a(Landroid/content/Context;Landroid/view/animation/Interpolator;)Landroid/support/v4/widget/w;
    ...
    :goto_0
    invoke-direct {v1, v0, p0, p1}, Landroid/support/v4/widget/w;-><init>(ZLandroid/content/Context;Landroid/view/animation/Interpolator;)V
...
.method public a(IIII)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/w;->a:Landroid/widget/OverScroller;
...
.method public f()F
    ...
    iget-boolean v0, p0, Landroid/support/v4/widget/w;->b:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/widget/w;->a:Landroid/widget/OverScroller;

    invoke-static {v0}, Landroid/support/v4/widget/x;->a(Ljava/lang/Object;)F
